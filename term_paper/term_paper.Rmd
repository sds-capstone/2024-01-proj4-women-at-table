...
```{r, out.width='70%', fig.align='center', fig.cap='Distribution on gender', echo=FALSE, fig.show='hold'}
     knitr::include_graphics('graphs/f24_graph2.png') 
```

``` {r, out.width='70%', fig.align='center', fig.cap='Distribution of having emergency fund by gender', echo=FALSE}
...
``` {r, out.width='110%', fig.align='center', fig.cap='Income Quantile Distribution', echo=FALSE}
...
``` {r, out.width='110%', fig.align='center', fig.cap='Income Quantile Distribution by gender', echo=FALSE}
...
``` {r, out.width='110%', fig.align='center', fig.cap='Employment Status Distribution by gender', echo=FALSE}
...
``` {r, out.width='110%', fig.align='center', fig.cap='Distributions of Access to Emergency Funds by country and gender', echo=FALSE}
