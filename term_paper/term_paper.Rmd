...
After basic data cleaning, we created a basic summary statistics table with the mean and standard deviations of each variable.
...
# Display the data
knitr::kable(summary_stats, caption = "Summary Statistics", digits = 3)
```

We also created various visualizations to help understand who is in the data and acknowledge potential sources of bias within the data.
...
```{r echo=FALSE}
# Read the CSV file
logit1 <- read.csv("logit1_results.csv")

# Display the data
knitr::kable(logit1, caption = "Logit 1 Regression Results")
```
...
```{r echo=FALSE}
# Read the CSV file
logit2 <- read.csv("logit2_results.csv")

# Display the data
knitr::kable(logit2, caption = "Logit 2 Regression Results")
```
...
```{r echo=FALSE}
# Read the CSV file
logit3 <- read.csv("logit3_results.csv")

# Display the data
knitr::kable(logit3, caption = "Logit 3 Regression Results")
```
